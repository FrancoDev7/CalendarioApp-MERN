...
describe('Pruebas en CalendarSlice', () => { 
  ...
  test('onAddNewEvent debe de agregar el evento ',  () => { 
    ...
    const newEvent = {
      id: '3',
      start: new Date('2024-12-23 13:00:00'),
      end: new Date('2024-12-23 14:00:00'),
      title: 'Event 3',
      notes : 'Test notes 3',
    };
  ...
  test('onUpdateEvent debe de actualizar el evento', () => { 
    ...
    const updateEvent = {
      ...
      title: 'Event 3 update',
      notes : 'Test notes 3 update',
    };
  ...
  test('onDeleteEvent debe de borrar el evento activo', () => { 
    ...
    expect( state.events ).not.toContain( events[0]) // el evento 1 ya no debe de existir en el array de eventos
  ...
  test('onLoadEvents debe de establecer los eventos', () => { 
      ...
      // debe de agregar los eventos al estado si ya existen eventos en el estado 
